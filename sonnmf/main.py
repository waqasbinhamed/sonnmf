...
from sonnmf.update_W import base as base_W, cyclic
EARLY_STOP_TOL = 1e-6
...
def sonnmf_cyclic(M, W, H, lam=0.0, gamma=0.0, itermin=500, itermax=10000, cyc=10,  H_update_iters=1, W_update_iters=100, accelerate_H_update=False, early_stop=True, verbose=False):
    """
    Performs non-negative matrix factorization with penalties on W and H.
    ...
    for it in range(1, itermax + 1):
        ...
        # update W
        cyclic(H, M, W, W_update_iters, gamma, lam, cyc)
