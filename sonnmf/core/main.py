...
def sonnmf(M, W, H, lam=0.0, gamma=0.0, itermin=200, itermax=1000, max_minutes=60, H_update_iters=1,
    ...
    Parameters:
        ...
        gamma (float): Penalty parameter for the non-negativity constraint on W.
    ...
    Returns:
        ...
        hscores (np.ndarray): Array of the non-negativity constraint violation value at each iteration.
    ...
    for it in range(1, itermax + 1):
        ...
        # Update W
        W = update_w_basic(H, M, W, W_update_iters, gamma, lam)
